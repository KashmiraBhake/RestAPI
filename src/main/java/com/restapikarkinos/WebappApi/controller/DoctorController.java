...
public class DoctorController {
  private static final String GET_ALL_DOCTORS_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/doctors";
  private static final String CREATE_DOCTOR_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/doctors";
  private static final String GET_DOCTOR_BY_SP_CT_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/finddoctors/?specialization={specialization}&city={city}";
  private static final String GET_DOCTOR_BY_ID_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/finddoctors/{id}";
  private static final String UPDATE_DOCTOR_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/doctors/{id}";  
  private static final String DELETE_DOCTOR_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/doctors/";
  private static final String PAGINATION_DOCTOR_API = "https://8080-apricot-tiger-sjwjyfje.ws-us08.gitpod.io/api/doctors/";
  static RestTemplate restTemplate = new RestTemplate();
    ...
    public ModelAndView viewAllDoctorapi(@PathVariable("page") Integer page) {
      ...
      private ModelAndView callGetDoctorBySpcAndCtAPI(@RequestParam String specialization,@RequestParam String city) throws JsonMappingException, 
